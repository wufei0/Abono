...
'    <Browsable(false),  _
'     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
'    Public ReadOnly Property Parameter_Financial_Year() As CrystalDecisions.[Shared].IParameterField
'        Get
...
'        Dim rpt As Assistance = New Assistance()
'        rpt.Site = Me.Site
'        Return rpt
'    End Function
